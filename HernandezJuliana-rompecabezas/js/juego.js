...
var instrucciones = ['Mezclar las piezas haciendo click en cualquier parte del tablero','Mover las piezas usando las flechas del teclado hasta lograr ordenar la figura'];
// Arreglo para ir guardando los movimientos que se vayan realizando
var movimientos = [];

// Representación de la grilla. Cada número representa a una pieza.
// El 9 es la posición vacía
const grillaOrdenada = [
    [1, 2, 3],
    [4, 5, 6],
    [7, 8, 9]
];
