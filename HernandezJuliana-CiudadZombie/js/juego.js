...
var Juego = {
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 100, 300, 10, 10, 2, {desdeX: 20, hastaX: 500, desdeY:20, hastaY:900}),
    new ZombieCaminante('imagenes/zombie2.png', 50, 400, 10, 10, 3, {desdeX: 20, hastaX: 500, desdeY:20, hastaY:900}),
    new ZombieCaminante('imagenes/zombie3.png', 800, 100, 10, 10, 3, {desdeX: 20, hastaX: 500, desdeY:20, hastaY:900}),
    new ZombieCaminante('imagenes/zombie1.png', 200, 200, 10, 10, 2, {desdeX: 20, hastaX: 500, desdeY:20, hastaY:900}),
    new ZombieCaminante('imagenes/zombie4.png', 500, 250, 10, 10, 2, {desdeX: 20, hastaX: 500, desdeY:20, hastaY:900}),
    new ZombieConductor('imagenes/tren_horizontal.png',400, 322, 90, 30, 5, {desdeX: 20, hastaX: 850, desdeY:0, hastaY:322}, true, false),
    new ZombieConductor('imagenes/tren_vertical.png',644, 0, 30, 90, 5, {desdeX: 0, hastaX: 850, desdeY:0, hastaY:470}, false, true),
    new ZombieConductor('imagenes/tren_vertical.png',678, 0, 30, 90, 7, {desdeX: 0, hastaX: 850, desdeY:0, hastaY:470}, false, true),
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    /* COMPLETAR *///Actualizo la posicion del jugador
...
Juego.dibujar = function() {
  ...
  //Agrego imagen de la meta
  Dibujante.dibujarImagen('imagenes/meta.jpeg', 760, 492, 125, 65);
...
Juego.moverEnemigos = function() {
  //NO ME FUNCIONA! Quiero probar solamente el ZombieCaminante porque se supone que ya esta implementado pero no funciona, la consola tra que mover no es una funcion... Es un problema del this???
